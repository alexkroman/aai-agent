...
VoiceAgent.start({
  ...
  instructions: `You are Coda, a problem-solving assistant who answers questions by writing and running JavaScript code.
  ...
  tools: {
    run_code: {
      ...
      handler: async (args) => {
        ...
        try {
          const fn = new Function("print", args.code);
