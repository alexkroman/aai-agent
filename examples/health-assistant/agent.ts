    ...
    drug_info: tool({
      ...
      handler: async ({ name }, ctx) => {
        ...
        try {
          ...
          data = FdaDrugLabelResponse.parse(raw);
        } catch {
        ...
        return {
          ...
          purpose: str(drug.purpose) ?? str(drug.indications_and_usage) ??
            "N/A",
      ...
      handler: async ({ drugs }, ctx) => {
        ...
        for (const drug of drugNames) {
          try {
            ...
            const data = RxCuiResponse.parse(raw);
        ...
        try {
          ...
          data = RxInteractionResponse.parse(raw);
        } catch {
