  ...
  tools: {
    ...
    convert_currency: {
      ...
      handler: async (args, ctx) => {
        ...
        if (!resp.ok)
          return {
            error: `Currency conversion failed: ${resp.statusText}`,
          };
        return resp.json();
      },
    },
    ...
    get_local_recommendations: {
      ...
      parameters: {
        ...
        category: {
          type: "string?",
          description:
            "Category filter: 'restaurants', 'attractions', 'nightlife', or 'all' (default 'all')",
        },
      },
      handler: async (args, ctx) => {
        ...
        if (!resp.ok)
          return {
            error: `Recommendations lookup failed: ${resp.statusText}`,
          };
        return resp.json();
      },
    },
    ...
    create_itinerary: {
      ...
      parameters: {
        ...
        notes: {
          type: "string",
          description: "Summary of planned flights, hotel, and activities",
        },
      },
      handler: async (args, ctx) => {
        ...
        if (!resp.ok)
          return {
            error: `Failed to save itinerary: ${resp.statusText}`,
          };
        return resp.json();
      },
    },
