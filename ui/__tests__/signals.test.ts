  ...
  describe("session event bridging", () => {
    ...
    it("appends to messages signal on message event", async () => {
      ...
      lastWs!.simulateMessage(
        JSON.stringify({ type: MSG.GREETING, text: "Hello!" }),
      );
      ...
      lastWs!.simulateMessage(
        JSON.stringify({ type: MSG.CHAT, text: "World", steps: [] }),
      );
    ...
    it("updates transcript signal on transcript event", async () => {
      ...
      lastWs!.simulateMessage(
        JSON.stringify({ type: MSG.TRANSCRIPT, text: "hello world" }),
      );
    ...
    it("updates error signal on error event", async () => {
      ...
      lastWs!.simulateMessage(
        JSON.stringify({ type: MSG.ERROR, message: "Server error" }),
      );
    ...
    it("clears messages, transcript, and error on reset event", async () => {
      ...
      lastWs!.simulateMessage(
        JSON.stringify({ type: MSG.TRANSCRIPT, text: "partial" }),
      );
      lastWs!.simulateMessage(
        JSON.stringify({ type: MSG.ERROR, message: "oops" }),
      );
