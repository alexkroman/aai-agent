...
import { createMockSignals, getContainer, setupDOM } from "./_dom-setup.ts";
import { SessionProvider } from "../context.tsx";
import { StateIndicator } from "../components/StateIndicator.tsx";
...
describe("ui components", { sanitizeOps: false, sanitizeResources: false }, () => {
  beforeEach(() => {
    setupDOM();
